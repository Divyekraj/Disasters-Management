...
if ($conn) {
    ...
    $result10=mysqli_query($conn,$q2);
    $total=0;
    while($row10=mysqli_fetch_array($result10)){
        $total=$total+$row10['cash'];
    }
...
<html>
        ...
        <div class="header">
            ...
            <div class="side_nav">
                ...
                <ul style="margin-top:30px;">
                    ...
                    <a href="request.php"><li class="menu">Disaster Requests</li></a>
            ...
            <div class="container">
                ...
                <div class="counting">
                    <div class="count_name">
                        <h3>Number of disasters in this year.</h3>
                        <hr >
                    </div>
                    <center><div class="number">
                            <span>315</span>
                ...
                <div class="counting">
                    <div class="count_name">
                        <h3><br>Total Cash Donated.</h3>
                        <hr>
                    </div> 
                    <center><div class="number" style="width:200px;">
                ...
                <div class="counting">
                    <div class="count_name">
                        <h3>Number of Organization are assosiated.</h3>
                        <hr>
                    </div> 
                    <center><div class="number">
                            <span>15</span>
                ...
                <div class="counting">
                    <div class="count_name">
                        <h3>Number of upcoming training events.</h3>
                        <hr>
                    </div>
                    <center> <div class="number">
                            <span><?php echo $num_row1; ?></span>
                        </div>
                    </center>
                </div>
            </div>
    ...
    <div class="footer">
        <span class='text' >&copy;Vishal & Vishal Production.</span>
    </div>
</body>
</html>
